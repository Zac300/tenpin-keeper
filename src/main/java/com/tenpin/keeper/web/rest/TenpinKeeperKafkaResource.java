...
@RestController
@RequestMapping("/api/tenpin-keeper-kafka")
public class TenpinKeeperKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TenpinKeeperKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TenpinKeeperKafkaResource(KafkaProperties kafkaProperties) {
